namespace ProgrammingAssignment03
{
    ...
    public class Game1 : Game
    {
        ...
        // delay support
        private const int TotalDelayMilliseconds = 1000;

        private int elapsedDelayMilliseconds = 0;

        // random velocity support
        private const float BaseSpeed = 0.15f;

        private Vector2 upLeft = new Vector2(-BaseSpeed, -BaseSpeed);
        private Vector2 upRight = new Vector2(BaseSpeed, -BaseSpeed);
        private Vector2 downRight = new Vector2(BaseSpeed, BaseSpeed);
        private Vector2 downLeft = new Vector2(-BaseSpeed, BaseSpeed);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                // STUDENTS: timer expired, so spawn new rock if fewer than 3 rocks in window Call
                // the GetRandomRock method to do this
                if (rock0 == null)
                {
                    rock0 = GetRandomRock();
                }
            ...
            // STUDENTS: Check each rock to see if it's outside the window. If so spawn a new random
            // rock for it by calling the GetRandomRock method
        ...
        {
            // STUDENTS: Uncomment and complete the code below to randomly pick a rock sprite by
            //           calling the GetRandomSprite method
            Texture2D sprite = GetRandomSprite();

            // STUDENTS: Uncomment and complete the code below to randomly pick a velocity by calling
            //           the GetRandomVelocity method
        ...
        {
            // STUDENTS: Uncommment and modify the code below as appropriate to return a random sprite
        ...
        {
            // STUDENTS: Uncommment and modify the code below as appropriate to return a random velocity
